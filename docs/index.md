...
1.1 | *file_system_snapshots* | [**FileSystemSnapshots1dot1Api**](FileSystemSnapshots1dot1Api.md) | API for the file system snapshots endpoint (**create**, **list**, **update** and **delete**) |
