# purity_fb_1dot5.HardwareApi

All URIs are relative to *https://purity_fb_server/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_hardware**](HardwareApi.md#list_hardware) | **GET** /1.5/hardware | 
[**update_hardware**](HardwareApi.md#update_hardware) | **PATCH** /1.5/hardware | 
