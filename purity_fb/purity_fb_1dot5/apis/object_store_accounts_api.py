...
class ObjectStoreAccountsApi(object):
    ...
    def create_object_store_accounts_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-accounts', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_object_store_accounts_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-accounts', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_object_store_accounts_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-accounts', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
