...
class VersionApi(object):
    ...
    def list_versions(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_versions(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.list_versions_with_http_info(**kwargs)
        else:
            (data) = self.list_versions_with_http_info(**kwargs)
            return data

    def list_versions_with_http_info(self, **kwargs):
        """
        Get all supported REST versions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_versions_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/api_version', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
