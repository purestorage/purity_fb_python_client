...
class ObjectStoreUsersApi(object):
    ...
    def create_object_store_users_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-users', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_object_store_users_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-users', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_object_store_users_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/object-store-users', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
