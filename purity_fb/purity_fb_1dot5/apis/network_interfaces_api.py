...
class NetworkInterfacesApi(object):
    ...
    def create_network_interfaces_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/network-interfaces', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_network_interfaces_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/network-interfaces', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_network_interfaces_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/network-interfaces', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_network_interfaces_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.5/network-interfaces', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
