...
class ApiClientPost(object):
    ...
    def __init__(self, max_role=None, issuer=None, public_key=None, access_token_ttl_in_ms=None):
        """
        ApiClientPost - a model defined in Swagger
        """
    ...
    def max_role(self, max_role):
        ...
        :param max_role: The max_role of this ApiClientPost.
    ...
    def issuer(self):
        """
        Gets the issuer of this ApiClientPost.
        The name of the identity provider that will be issuing ID Tokens for this API client. The iss claim in the JWT issued must match this string. If not specified, defaults to the API client name. Modifiable

        :return: The issuer of this ApiClientPost.
        :rtype: str
        """
        return self._issuer
    ...
    def issuer(self, issuer):
        ...
        :param issuer: The issuer of this ApiClientPost.
        :type: str
        """
    ...
    def public_key(self):
        """
        Gets the public_key of this ApiClientPost.
        The API client’s PEM formatted (Base64 encoded) RSA public key. It must include the -----BEGIN PUBLIC KEY----- and -----END PUBLIC KEY----- lines. Modifiable

        :return: The public_key of this ApiClientPost.
        :rtype: str
        """
    ...
    def public_key(self, public_key):
        ...
        :param public_key: The public_key of this ApiClientPost.
        :type: str
        """
    ...
    def access_token_ttl_in_ms(self):
        """
        Gets the access_token_ttl_in_ms of this ApiClientPost.
        The TTL (Time To Live) duration for which the exchanged access token is valid. Measured in milliseconds. If not specified, defaults to 86400000. Modifiable

        :return: The access_token_ttl_in_ms of this ApiClientPost.
        :rtype: int
        """
    ...
    def access_token_ttl_in_ms(self, access_token_ttl_in_ms):
        ...
        :param access_token_ttl_in_ms: The access_token_ttl_in_ms of this ApiClientPost.
        :type: int
        """
