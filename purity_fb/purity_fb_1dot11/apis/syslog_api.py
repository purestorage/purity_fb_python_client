...
class SyslogApi(object):
    ...
    def create_syslog_servers(self, syslog, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_syslog_servers(syslog, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_syslog_servers_with_http_info(syslog, **kwargs)
        else:
            (data) = self.create_syslog_servers_with_http_info(syslog, **kwargs)
            return data

    def create_syslog_servers_with_http_info(self, syslog, **kwargs):
        """
        Configure a new syslog server. Transmission of syslog messages is enabled immediately.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_syslog_servers_with_http_info(syslog, callback=callback_function)
        ...
        return self.api_client.call_api('/1.11/syslog-servers', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_syslog_servers_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_syslog_servers_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_syslog_settings_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers/settings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def test_syslog_config_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers/test', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_syslog_servers_with_http_info(self, syslog, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_syslog_settings_with_http_info(self, syslog_settings, **kwargs):
        ...
        return self.api_client.call_api('/1.11/syslog-servers/settings', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
