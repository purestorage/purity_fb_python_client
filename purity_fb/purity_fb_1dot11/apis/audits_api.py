...
class AuditsApi(object):
    ...
    def list_audits(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_audits(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.list_audits_with_http_info(**kwargs)
        else:
            (data) = self.list_audits_with_http_info(**kwargs)
            return data

    def list_audits_with_http_info(self, **kwargs):
        """
        List audits.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_audits_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/1.11/audits', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
