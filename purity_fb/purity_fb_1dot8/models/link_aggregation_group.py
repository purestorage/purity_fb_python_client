...
class LinkAggregationGroup(object):
    ...
    def __init__(self, id=None, name=None, lag_speed=None, mac_address=None, ports=None, port_speed=None, status=None):
        """
    ...
    def id(self):
        """
        Gets the id of this LinkAggregationGroup.
        A non-modifiable, globally unique ID chosen by the system.

        :return: The id of this LinkAggregationGroup.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this LinkAggregationGroup.
        :type: str
        """
