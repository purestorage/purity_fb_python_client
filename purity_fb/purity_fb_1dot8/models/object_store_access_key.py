...
class ObjectStoreAccessKey(object):
    ...
    def __init__(self, name=None, created=None, id=None, user=None, enabled=None, secret_access_key=None):
        """
    ...
    def id(self):
        """
        Gets the id of this ObjectStoreAccessKey.
        A non-modifiable, globally unique ID chosen by the system.

        :return: The id of this ObjectStoreAccessKey.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this ObjectStoreAccessKey.
        :type: str
        """
