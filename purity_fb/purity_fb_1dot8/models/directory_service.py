...
#END_CUSTOM
    ...
    def __init__(self, id=None, name=None, base_dn=None, bind_password=None, bind_user=None, ca_certificate=None, ca_certificate_group=None, enabled=None, services=None, uris=None, smb=None, nfs=None):  # noqa: E501
