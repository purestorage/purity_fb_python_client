...
class FileSystemSnapshot(object):
    ...
    def __init__(self, name=None, created=None, id=None, destroyed=None, policy=None, source=None, source_destroyed=None, source_id=None, suffix=None, time_remaining=None):
        """
