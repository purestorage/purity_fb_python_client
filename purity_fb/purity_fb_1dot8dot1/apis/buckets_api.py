...
class BucketsApi(object):
    ...
    def create_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/buckets', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/buckets', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/buckets', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_buckets_performance_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/buckets/performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_buckets_s3_specific_performance_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/buckets/s3-specific-performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_buckets_with_http_info(self, **kwargs):
        ...
        all_params = ['ids', 'names', 'destroyed']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.8.1/buckets', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
