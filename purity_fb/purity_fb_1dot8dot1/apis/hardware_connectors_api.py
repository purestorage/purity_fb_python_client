...
class HardwareConnectorsApi(object):
    ...
    def list_hardware_connectors_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/hardware-connectors', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_hardware_connectors_with_http_info(self, **kwargs):
        ...
        all_params = ['ids', 'names', 'hardware_connector']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.8.1/hardware-connectors', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
