...
class DirectoryServicesApi(object):
    ...
    def list_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/directory-services', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_directory_services_roles_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/directory-services/roles', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def test_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.8.1/directory-services/test', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def test_directory_services_with_changes(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_directory_services_with_changes(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_directory_services_with_changes_with_http_info(**kwargs)
        else:
            (data) = self.test_directory_services_with_changes_with_http_info(**kwargs)
            return data

    def test_directory_services_with_changes_with_http_info(self, **kwargs):
        """
        Test directory services with changes.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_directory_services_with_changes_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method test_directory_services_with_changes" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/1.8.1/directory-services/test', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_with_http_info(self, directory_service, **kwargs):
        ...
        all_params = ['directory_service', 'ids', 'names']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.8.1/directory-services', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_roles_with_http_info(self, names, directory_service_role, **kwargs):
        ...
        all_params = ['names', 'directory_service_role', 'ids']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.8.1/directory-services/roles', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
