...
class DnsResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        DnsResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this DnsResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this DnsResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this DnsResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this DnsResponse.
        a list of dns configuration objects

        :return: The items of this DnsResponse.
        :rtype: list[Dns]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this DnsResponse.
        :type: list[Dns]
        """
