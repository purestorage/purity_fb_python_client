...
class FileSystemsApi(object):
    ...
    def create_file_systems_with_http_info(self, file_system, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def create_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems/policies', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_file_systems_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems/policies', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_performance_with_http_info(self, **kwargs):
        ...
        all_params = ['resolution', 'protocol', 'end_time', 'filter', 'limit', 'names', 'sort', 'start_time', 'start', 'token', 'total_only']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.6/file-systems/performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems/policies', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_file_systems_with_http_info(self, name, attributes, **kwargs):
        ...
        return self.api_client.call_api('/1.6/file-systems', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
