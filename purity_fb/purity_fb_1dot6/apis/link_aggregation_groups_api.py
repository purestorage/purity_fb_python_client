...
class LinkAggregationGroupsApi(object):
    ...
    def create_link_aggregation_groups_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/link-aggregation-groups', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_link_aggregation_groups_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/link-aggregation-groups', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_link_aggregation_groups_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/link-aggregation-groups', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_link_aggregation_groups_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/link-aggregation-groups', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
