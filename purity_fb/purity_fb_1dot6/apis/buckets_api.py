...
class BucketsApi(object):
    ...
    def create_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/buckets', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/buckets', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/buckets', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_buckets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.6/buckets', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
