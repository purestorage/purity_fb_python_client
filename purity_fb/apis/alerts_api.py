...
class AlertsApi(object):
    ...
    def update_alerts(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_alerts(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_alerts_with_http_info(**kwargs)
        else:
            (data) = self.update_alerts_with_http_info(**kwargs)
            return data

    def update_alerts_with_http_info(self, **kwargs):
        """
        Update alerts
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_alerts_with_http_info(callback=callback_function)
