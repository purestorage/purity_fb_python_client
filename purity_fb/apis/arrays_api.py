...
class ArraysApi(object):
    ...
    def list_arrays_http_specific_performance_with_http_info(self, **kwargs):
        ...
        all_params = ['names', 'filter', 'sort', 'start', 'limit', 'token', 'start_time', 'end_time', 'resolution']
    ...
    def list_arrays_performance_with_http_info(self, **kwargs):
        ...
        all_params = ['names', 'filter', 'sort', 'start', 'limit', 'token', 'start_time', 'end_time', 'resolution', 'protocol']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_arrays_space_with_http_info(self, **kwargs):
        ...
        all_params = ['names', 'filter', 'sort', 'start', 'limit', 'token', 'start_time', 'end_time', 'resolution', 'type']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
