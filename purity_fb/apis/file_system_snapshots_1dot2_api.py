...
class FileSystemSnapshots1dot2Api(object):
    """
    ...
    def create_file_system_snapshots_with_http_info(self, sources, **kwargs):
        ...
        return self.api_client.call_api('/1.2/file-system-snapshots', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_file_system_snapshots_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/1.2/file-system-snapshots', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_system_snapshots_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.2/file-system-snapshots', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_file_system_snapshots(self, name, attributes, **kwargs):
        ...
        :param FileSystemSnapshot attributes: the new attributes, only modifiable fields could be used. (required)
        :return: FileSystemSnapshotResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_file_system_snapshots_with_http_info(self, name, attributes, **kwargs):
        ...
        return self.api_client.call_api('/1.2/file-system-snapshots', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
