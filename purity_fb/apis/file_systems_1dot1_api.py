...
class FileSystems1dot1Api(object):
    """
    ...
    def create_file_systems_with_http_info(self, file_system, **kwargs):
        ...
        return self.api_client.call_api('/1.1/file-systems', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_file_systems_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/1.1/file-systems', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.1/file-systems', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_file_systems_with_http_info(self, name, attributes, **kwargs):
        ...
        return self.api_client.call_api('/1.1/file-systems', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
