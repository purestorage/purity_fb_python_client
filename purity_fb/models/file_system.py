...
class FileSystem(object):
    ...
    def __init__(self, name=None, created=None, fast_remove_directory_enabled=False, provisioned=0, snapshot_directory_enabled=False, space=None, nfs=None, http=None, smb=None):
        """
