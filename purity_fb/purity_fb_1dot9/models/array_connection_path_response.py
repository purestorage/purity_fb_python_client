...
class ArrayConnectionPathResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        ArrayConnectionPathResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this ArrayConnectionPathResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this ArrayConnectionPathResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this ArrayConnectionPathResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this ArrayConnectionPathResponse.
        A list of array connection path objects.

        :return: The items of this ArrayConnectionPathResponse.
    ...
    def items(self, items):
        ...
        :param items: The items of this ArrayConnectionPathResponse.
