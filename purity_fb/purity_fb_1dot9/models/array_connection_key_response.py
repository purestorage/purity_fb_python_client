...
class ArrayConnectionKeyResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        ArrayConnectionKeyResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this ArrayConnectionKeyResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this ArrayConnectionKeyResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this ArrayConnectionKeyResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this ArrayConnectionKeyResponse.
        A list of array connection key objects.

        :return: The items of this ArrayConnectionKeyResponse.
    ...
    def items(self, items):
        ...
        :param items: The items of this ArrayConnectionKeyResponse.
