...
class ReferenceName(object):
    ...
    def __init__(self, name=None):
        """
        ReferenceName - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this ReferenceName.
        A name chosen by the user. Can be changed. Must be locally unique.

        :return: The name of this ReferenceName.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ReferenceName.
        :type: str
        """
