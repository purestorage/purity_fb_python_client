...
class QuotasUsersApi(object):
    ...
    def create_user_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/users', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_user_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/users', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_user_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/users', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_user_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/users', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
