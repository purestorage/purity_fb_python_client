...
class QuotasGroupsApi(object):
    ...
    def create_group_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/groups', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_group_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/groups', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_group_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/groups', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_group_quotas_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/quotas/groups', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
