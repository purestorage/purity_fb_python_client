...
class FileSystemsApi(object):
    ...
    def create_file_systems_with_http_info(self, file_system, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def create_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems/policies', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_file_systems_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems/policies', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_groups_performance(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_file_systems_groups_performance(callback=callback_function)
        ...
        :return: FileSystemGroupPerformanceResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_file_systems_groups_performance_with_http_info(**kwargs)
        else:
            (data) = self.list_file_systems_groups_performance_with_http_info(**kwargs)
            return data

    def list_file_systems_groups_performance_with_http_info(self, **kwargs):
        """
        List instant file system groups performance.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_file_systems_groups_performance_with_http_info(callback=callback_function)
        ...
        all_params = ['names', 'filter', 'limit', 'sort', 'start', 'token', 'file_system_names', 'gids']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_file_systems_groups_performance" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/1.12/file-systems/groups/performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FileSystemGroupPerformanceResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def list_file_systems_performance_with_http_info(self, protocol, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems/performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_systems_users_performance(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_file_systems_users_performance(callback=callback_function)
        ...
        :return: FileSystemUserPerformanceResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_file_systems_users_performance_with_http_info(**kwargs)
        else:
            (data) = self.list_file_systems_users_performance_with_http_info(**kwargs)
            return data

    def list_file_systems_users_performance_with_http_info(self, **kwargs):
        """
        List instant file system users performance.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_file_systems_users_performance_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_file_systems_users_performance" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/1.12/file-systems/users/performance', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='FileSystemUserPerformanceResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def list_filesystem_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/file-systems/policies', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_file_systems(self, attributes, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param FileSystemPatch attributes: The new attributes, only modifiable fields may be specified. (required)
        :param list[str] ids: A comma-separated list of resource IDs. This cannot be provided together with the name or names query parameters.
        :param str name: The name of the file system or snapshot to be updated.
    ...
    def update_file_systems_with_http_info(self, attributes, **kwargs):
        ...
        all_params = ['attributes', 'ids', 'name', 'discard_detailed_permissions', 'discard_non_snapshotted_data', 'delete_link_on_eradication', 'ignore_usage']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.12/file-systems', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
