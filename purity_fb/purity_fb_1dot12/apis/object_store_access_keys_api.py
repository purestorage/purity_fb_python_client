...
class ObjectStoreAccessKeysApi(object):
    ...
    def create_object_store_access_keys_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-access-keys', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_object_store_access_keys_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-access-keys', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_object_store_access_keys_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-access-keys', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_object_store_access_keys_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-access-keys', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
