...
class ObjectStoreRemoteCredentialsApi(object):
    ...
    def create_object_store_remote_credentials_with_http_info(self, remote_credentials, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-remote-credentials', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_object_store_remote_credentials_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-remote-credentials', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_object_store_remote_credentials_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-remote-credentials', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_object_store_remote_credentials_with_http_info(self, remote_credentials, **kwargs):
        ...
        return self.api_client.call_api('/1.12/object-store-remote-credentials', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
