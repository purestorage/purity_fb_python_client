...
class SnmpAgentsApi(object):
    ...
    def list_snmp_agents_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/snmp-agents', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_snmp_agents_mib_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.12/snmp-agents/mib', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_snmp_agents_with_http_info(self, snmp_agent, **kwargs):
        ...
        return self.api_client.call_api('/1.12/snmp-agents', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
