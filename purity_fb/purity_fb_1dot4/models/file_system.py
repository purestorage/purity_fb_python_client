...
#END_CUSTOM
    ...
    def __init__(self, name=None, created=None, fast_remove_directory_enabled=None, provisioned=None, hard_limit_enabled=None, snapshot_directory_enabled=None, nfs=None, http=None, smb=None, destroyed=None, time_remaining=None, space=None):  # noqa: E501
