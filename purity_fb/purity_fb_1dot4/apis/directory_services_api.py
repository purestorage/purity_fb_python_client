...
class DirectoryServicesApi(object):
    ...
    def list_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.4/directory-services', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_directory_services_roles_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.4/directory-services/roles', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def test_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.4/directory-services/test', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_with_http_info(self, directory_service, **kwargs):
        ...
        return self.api_client.call_api('/1.4/directory-services', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_roles_with_http_info(self, names, directory_service_role, **kwargs):
        ...
        return self.api_client.call_api('/1.4/directory-services/roles', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
