...
class BladeResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        BladeResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this BladeResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this BladeResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this BladeResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this BladeResponse.
        a list of blade objects

        :return: The items of this BladeResponse.
        :rtype: list[Blade]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this BladeResponse.
        :type: list[Blade]
        """
