...
#END_CUSTOM
    ...
    def __init__(self, name=None, created=None, default_user_quota=None, default_group_quota=None, destroyed=None, fast_remove_directory_enabled=None, hard_limit_enabled=None, http=None, nfs=None, provisioned=None, snapshot_directory_enabled=None, smb=None, space=None, time_remaining=None):  # noqa: E501
