...
class SmtpResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        SmtpResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this SmtpResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this SmtpResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this SmtpResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this SmtpResponse.
        a list of smtp configuration objects

        :return: The items of this SmtpResponse.
        :rtype: list[Smtp]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this SmtpResponse.
        :type: list[Smtp]
        """
