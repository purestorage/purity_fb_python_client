...
class FileSystemSnapshotsApi(object):
    ...
    def create_file_system_snapshots_with_http_info(self, sources, **kwargs):
        ...
        return self.api_client.call_api('/1.7/file-system-snapshots', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_file_system_snapshots_with_http_info(self, name, **kwargs):
        ...
        return self.api_client.call_api('/1.7/file-system-snapshots', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_file_system_snapshots_with_http_info(self, **kwargs):
        ...
        all_params = ['filter', 'sort', 'start', 'limit', 'token', 'total_only', 'names_or_sources']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api('/1.7/file-system-snapshots', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_filesystem_snapshot_policies_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.7/file-system-snapshots/policies', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_file_system_snapshots_with_http_info(self, attributes, **kwargs):
        ...
        return self.api_client.call_api('/1.7/file-system-snapshots', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
