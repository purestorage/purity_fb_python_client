...
class SupportApi(object):
    ...
    def list_support_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/support', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def test_support_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/support/test', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_support_with_http_info(self, support, **kwargs):
        ...
        return self.api_client.call_api('/1.10/support', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
