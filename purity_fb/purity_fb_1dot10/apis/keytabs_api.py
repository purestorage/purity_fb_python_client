...
class KeytabsApi(object):
    ...
    def delete_keytabs_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/keytabs', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def download_keytab_file_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/keytabs/download', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_keytabs_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/keytabs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def upload_keytab_file_with_http_info(self, keytab_file, **kwargs):
        ...
        return self.api_client.call_api('/1.10/keytabs/upload', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
