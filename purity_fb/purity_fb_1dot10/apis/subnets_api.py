...
class SubnetsApi(object):
    ...
    def create_subnets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/subnets', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_subnets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/subnets', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_subnets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/subnets', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_subnets_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.10/subnets', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
