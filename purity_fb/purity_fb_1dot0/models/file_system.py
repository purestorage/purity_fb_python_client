...
#END_CUSTOM
    ...
    def __init__(self, name=None, created=None, fast_remove_directory_enabled=None, provisioned=None, snapshot_directory_enabled=None, nfs=None, http=None, smb=None, space=None):  # noqa: E501
