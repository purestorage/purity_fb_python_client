...
class DirectoryServicesApi(object):
    ...
    def list_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.3/directory-services', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def list_directory_services_settings(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_directory_services_settings(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :return: DirectoryServiceSettingsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_directory_services_settings_with_http_info(**kwargs)
        else:
            (data) = self.list_directory_services_settings_with_http_info(**kwargs)
            return data

    def list_directory_services_settings_with_http_info(self, **kwargs):
        """
        List directory services global settings
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_directory_services_settings_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_directory_services_settings" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/1.3/directory-services/settings', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='DirectoryServiceSettingsResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def test_directory_services_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/1.3/directory-services/test', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_with_http_info(self, directory_service, **kwargs):
        ...
        return self.api_client.call_api('/1.3/directory-services', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_directory_services_settings(self, directory_service_settings, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_directory_services_settings(directory_service_settings, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param DirectoryServiceSettings directory_service_settings: (required)
        :return: DirectoryServiceSettingsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_directory_services_settings_with_http_info(directory_service_settings, **kwargs)
        else:
            (data) = self.update_directory_services_settings_with_http_info(directory_service_settings, **kwargs)
            return data

    def update_directory_services_settings_with_http_info(self, directory_service_settings, **kwargs):
        """
        Update directory services global settings
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_directory_services_settings_with_http_info(directory_service_settings, callback=callback_function)
        ...
        all_params = ['directory_service_settings']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_directory_services_settings" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'directory_service_settings' is set
        if ('directory_service_settings' not in params) or (params['directory_service_settings'] is None):
            raise ValueError("Missing the required parameter `directory_service_settings` when calling `update_directory_services_settings`")
        ...
        body_params = None
        if 'directory_service_settings' in params:
            body_params = params['directory_service_settings']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
        ...
        return self.api_client.call_api('/1.3/directory-services/settings', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
