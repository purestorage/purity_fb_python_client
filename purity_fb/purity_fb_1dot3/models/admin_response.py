...
class AdminResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        AdminResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this AdminResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this AdminResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this AdminResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this AdminResponse.
        a list of administrative account objects

        :return: The items of this AdminResponse.
        :rtype: list[Admin]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this AdminResponse.
        :type: list[Admin]
        """
