...
class HardwareResponse(object):
    ...
    def __init__(self, pagination_info=None, items=None):
        """
        HardwareResponse - a model defined in Swagger
        """
    ...
    def pagination_info(self):
        """
        Gets the pagination_info of this HardwareResponse.
        pagination information, only available in GET requests

        :return: The pagination_info of this HardwareResponse.
    ...
    def pagination_info(self, pagination_info):
        ...
        :param pagination_info: The pagination_info of this HardwareResponse.
        :type: PaginationInfo
        """
    ...
    def items(self):
        """
        Gets the items of this HardwareResponse.
        a list of hardware components

        :return: The items of this HardwareResponse.
        :rtype: list[Hardware]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this HardwareResponse.
        :type: list[Hardware]
        """
